...
#define SPINOR_REG_MXIC_OPI_EN		0x1		/* Enable Octal */
...
/**
 * spi_nor_macronix_octal_enable() - Enable octal on Macronix flashes.
 * @nor:		pointer to a 'struct spi_nor'
 * @enable:		whether to enable Octal or switch back to SPI
 *
 * Return: 0 on success, -errno otherwise.
 */
static int spi_nor_macronix_octal_enable(struct spi_nor *nor, bool enable)
{
	...
	if (!enable)
		spi_nor_spimem_setup_op(nor, &op, SNOR_PROTO_8_8_8);
...
{
	nor->params->octal_str_enable = spi_nor_macronix_octal_enable;
	nor->params->octal_dtr_enable = spi_nor_macronix_octal_enable;
}
...
static const struct flash_info macronix_parts[] = {
	...
	{ "mx66lm2g45g", INFO(0xc2853c, 0, 64 * 1024, 4096,
			      SECT_4K | SPI_NOR_OPI_READ |
			      SPI_NOR_OPI_PP | SPI_NOR_4B_OPCODES)
